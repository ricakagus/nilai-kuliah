...
<div class="content-wrapper">
  ...
  <div class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1 class="m-0">Detail Kontrak Nilai</h1>
        </div><!-- /.col -->
        <div class="col-sm-6">
            ...
            <form action="" method="post">
              ...
              <div class="card-body mb-0">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="tahunakademik" id="" placeholder="xxxxx" value="<?= $kontrak['tahunAkademik']; ?>">
                ...
                <div class="form-group">
                  ...
                  <select name="matakuliah" class="form-control">
                    ...
                    <?php foreach ($dataMataKuliah as $dm) : ?>
                      <?php if ($kontrak['mataKuliah'] == $dm['nama']) : ?>
                  ...
                  <div class="row pb-0">
                    <div class="col-3">
                      ...
                      <div class="input-group ">
                        <input type="text" class="form-control" name="kehadiran" value="<?= $kontrak['kehadiran']; ?>">
                    ...
                    <div class="col-3">
                      ...
                      <div class="input-group ">
                        <input type="text" class="form-control" name="tugas" value="<?= $kontrak['tugas']; ?>">
                        <div class="input-group-append">
                          <span class="input-group-text">%</span>
                        </div>
                      </div>
                    ...
                    <div class="col-3">
                      <label for="">UTS</label>
                      <div class="input-group ">
                        <input type="text" class="form-control" name="uts" value="<?= $kontrak['UTS']; ?>">
                        <div class="input-group-append">
                          <span class="input-group-text">%</span>
                        </div>
                      </div>
                    ...
                    <div class="col-3">
                      <label for="">UAS</label>
                      <div class="input-group">
                        <input type="text" class="form-control" name="uas" value="<?= $kontrak['UAS']; ?>">
                        <div class="input-group-append">
                          <span class="input-group-text">%</span>
                        </div>
                      </div>
