...
$route['starterpage'] = 'homeC/starter';
$route['matakuliah'] = 'matakuliahC';
$route['matakuliah/inputmk'] = 'matakuliahC/inputMK';
$route['matakuliah/detailmk/(:any)'] = 'matakuliahC/detailMK/$1';
$route['matakuliah/deletemk/(:any)'] = 'matakuliahC/deleteMK/$1';

$route['mahasiswa'] = 'mahasiswac';
$route['mahasiswa/input'] = 'mahasiswac/inputmahasiswa';
$route['mahasiswa/detail/(:any)'] = 'mahasiswac/detailmahasiswa/$1';
$route['mahasiswa/update/(:any)'] = 'mahasiswac/updatemahasiswa/$1';
